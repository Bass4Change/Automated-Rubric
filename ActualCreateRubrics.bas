...
If Silly = True Then
    ...
    Do Until IsEmpty(ClassRoster.Cells(iRow, 1))
        ...
        If ClassRoster.Cells(iRow, 2) = "" Then
            
            iRow = iRow + 1
        
        Else:
                
            sPath = ClassRoster.Cells(iRow, 1)
            If sPath = "0" Then
                
                Workbooks.Add (1)
                MacGetSaveAsFilenameExcel MyInitialFilename:="0 Period", FileExtension:="xlsm"
                iRow = iRow + 1
            ...
            Else:
                ...
                If sPath = "1" Then
                    ...
                    Workbooks.Add (1)
                    MacGetSaveAsFilenameExcel MyInitialFilename:="1st Period", FileExtension:="xlsm"
                    iRow = iRow + 1
                ...
                Else:
                    ...
                    If sPath = "2" Then
                        ...
                        Workbooks.Add (1)
                        MacGetSaveAsFilenameExcel MyInitialFilename:="2nd Period", FileExtension:="xlsm"
                        iRow = iRow + 1
                    ...
                    Else:
                        ...
                        If sPath = "3" Then
                            ...
                            Workbooks.Add (1)
                            MacGetSaveAsFilenameExcel MyInitialFilename:="3rd Period", FileExtension:="xlsm"
                            iRow = iRow + 1
                        ...
                        Else:
                            ...
                            If sPath = 4 Then
                                ...
                                Workbooks.Add (1)
                                MacGetSaveAsFilenameExcel MyInitialFilename:=sPath & "th Period", FileExtension:="xlsm"
                                iRow = iRow + 1
    ...
    Loop
        ...
        CellNumber = True
        beauty = ClassRoster.Cells(iRow - 1, 1)
        ...
        Do While CellNumber = True
                ...
                If InStr(1, CellName, ".") > 0 Then
                    
                    NumberofCharacters = (InStr(1, CellName, "."))
                    
                    NewCellName = Left(CellName, Len(CellName) - 3)
                    
                    RosterName = NewCellName
                    
                    If beauty = 0 Then
                    
                        ws1.Copy Before:=Workbooks("0 Period.xlsm").Worksheets("Sheet1")
                        Set ws2 = Workbooks("0 Period.xlsm").ActiveSheet
                        ws2.Name = NewCellName
                        Set ReName = ws2.Cells(2, 1)
                        ReName = "Name: " & NewCellName
                        ReName.Font.Size = 12
                    ...
                    Else:
                        ...
                        If beauty = 1 Then
                            ...
                            ws1.Copy Before:=Workbooks("1st Period.xlsm").Worksheets("Sheet1")
                            Set ws2 = Workbooks("1st Period.xlsm").ActiveSheet
                            ws2.Name = NewCellName
                            Set ReName = ws2.Cells(2, 1)
                            ReName = "Name: " & NewCellName
                            ReName.Font.Size = 12
                        ...
                        Else:
                            ...
                            If beauty = 2 Then
                                ...
                                ws1.Copy Before:=Workbooks("2nd Period.xlsm").Worksheets("Sheet1")
                                Set ws2 = Workbooks("2nd Period.xlsm").ActiveSheet
                                ws2.Name = NewCellName
                                Set ReName = ws2.Cells(2, 1)
                                ReName = "Name: " & NewCellName
                                ReName.Font.Size = 12
                            ...
                            Else:
                                ...
                                If beauty = 3 Then
                                    ...
                                    ws1.Copy Before:=Workbooks("3rd Period.xlsm").Worksheets("Sheet1")
                                    Set ws2 = Workbooks("3rd Period.xlsm").ActiveSheet
                                    ws2.Name = NewCellName
                                    Set ReName = ws2.Cells(2, 1)
                                    ReName = "Name: " & NewCellName
                                    ReName.Font.Size = 12
                                ...
                                Else:
                                    ...
                                    ws1.Copy Before:=Workbooks(beauty & "th Period.xlsm").Worksheets("Sheet1")
                                    Set ws2 = Workbooks(beauty & "th Period.xlsm").ActiveSheet
                                    ws2.Name = NewCellName
                                    Set ReName = ws2.Cells(2, 1)
                                    ReName = "Name: " & NewCellName
                                    ReName.Font.Size = 12
                ...
                If Not IsEmpty(ClassRoster.Cells(iRow, 2)) Then
            
                    beauty = ClassRoster.Cells(iRow, 1)
                    CellNumber = True
                    iRow = iRow + 1
                
                Else:
                
                    If Not IsEmpty(ClassRoster.Cells(iRow, 1)) Then
